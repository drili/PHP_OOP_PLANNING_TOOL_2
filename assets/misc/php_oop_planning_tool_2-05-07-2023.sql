...
--
-- Vært: 127.0.0.1
-- Genereringstid: 05. 07 2023 kl. 11:55:10
...
CREATE TABLE `customers` (
  ...
  `customer_type` varchar(255) NOT NULL DEFAULT 'client'
...
INSERT INTO `customers` (`customer_id`, `customer_name`, `customer_cvr`, `customer_color`, `customer_hourly_rate`, `customer_enabled`, `customer_type`) VALUES
(1, 'hawdaha 1', 124151, '#e3e3e3', 1000, 1, 'internal'),
(2, 'hawda 2', 124151, '#f0f8ff', 1000, 1, 'internal'),
(3, 'hawdawd 3', 124151, '#7fffd4', 1000, 1, 'client'),
(4, 'hq32dad', 124151, '#8a2be2', 1000, 1, 'client'),
(5, 'w4daa', 124151, '#ff7f50', 1000, 1, 'client'),
(6, 'hawdawd awda', 124151, '#ee82ee', 1000, 1, 'client'),
(7, 'yqeawd awd', 124151, '#00ff7f', 1000, 1, 'client'),
(8, 'yqeawd aw 8', 124151, '#b8860b', 1000, 0, 'client');
...
(90, 'Test Alloc', 2, 5, 0, '<p>hawdawda</p>', 7, 2, 1, 0, 1, 0, '2023-07-04 11:55:27', 3, 0),
(91, 'Test Alloc', 2, 5, 0, '<p>hawdawda</p>', 8, 2, 1, 0, 1, 0, '2023-07-04 11:55:27', 3, 0),
(92, 'Test Alloc 2 ', 3, 5, 3, '<p>hawdawd</p>', 7, 2, 2, 0, 1, 0, '2023-07-04 12:08:27', 3, 0);
...
INSERT INTO `time_registrations` (`time_registration_id`, `time_registration_amount`, `time_registration_date`, `task_id`, `person_id`, `time_registration_note`, `registration_type`) VALUES
(1, '2.00', '2023-06-25', 87, 3, '', NULL),
(2, '2.00', '2023-06-25', 87, 3, '', NULL),
(3, '1.00', '2023-06-26', 87, 3, '', NULL),
(4, '0.50', '2023-06-27', 87, 3, '', NULL),
(5, '1.00', '2023-06-25', 87, 3, '', NULL),
(6, '1.00', '2023-06-26', 84, 3, '', NULL),
(7, '2.00', '2023-06-27', 84, 3, '', NULL),
(8, '2.00', '2023-06-27', 89, 3, '', NULL),
(9, '2.00', '2023-07-04', 89, 3, '', NULL),
(10, '2.00', '2023-07-05', 92, 3, '', NULL),
(11, '4.00', '2023-07-03', 92, 3, '', 'internal');
...
--
ALTER TABLE `time_registrations`
  MODIFY `time_registration_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
